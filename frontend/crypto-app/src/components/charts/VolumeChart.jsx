 ...
 * @returns {JSX.Element} Volume chart component or empty state message
 */
const VolumeChart = ({ data, className = '', id = 'volume-chart' }) => {
  ...
  /**
   * Format data for volume chart visualization
